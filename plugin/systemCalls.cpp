...
Q_INVOKABLE void systemCalls::upgradeSystem(bool konsoleFlag, bool aur, bool noconfirm, bool yakuakeFlag)
{
	if (!systemCalls::isConnectedToNetwork())
	{
		worker->updates = QStringList();
	...
	emit systemCalls::upgradeSystemSignal(konsoleFlag, aur, noconfirm,yakuakeFlag);
}
